...
y se tratan de ejercicios descriptivos de la estructura del modelo. Para modelos más complicados es necesario usar herramientas más complejas.
...
```
Claramente reperamos los coeficientes reales con este ejemplo.
...
sabemos que es 2 unidades. Sin embargo, esto no tiene nada qué
