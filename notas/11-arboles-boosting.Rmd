...
params = list(
    ...
    max_depth = 4, # profundidad de árboles
    subsample = 0.5, lambda = 5)
res <- ajustar_mod(d_entrena, verbose = 1, nrounds = 5000, params = params)
```
...
de usar GPUs para el entrenamiento, y aproximaciones eficientes para encontrar los cortes para cada estructura [@xgboost].
de árbol.
