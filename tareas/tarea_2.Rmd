...
```{r}
n <- ### rellena aquí un valor apropiado
eta <- ## rellena aquí un valor apropiado
...
```{r}
## Aquí tu código, puedes usar la función "error" que definiste arriba
```
...
beta <- ## pon aquí los valores que encontraste
